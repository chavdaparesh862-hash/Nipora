...
export default function SyncedPlayer({
  ...
  }, [videoUrl, isPlaying, currentTime, lastUpdated, ytReady, isYoutube]);
      ...
      >
        ...
        <div className="flex items-center justify-between w-full" id="buttons-controls-row">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 group/volume">
              ...
              <input
                ...
                className="w-0 group-hover/volume:w-20 transition-all duration-300 origin-left accent-purple-600 h-1 rounded-md appearance-none cursor-pointer bg-zinc-700"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handleForceResync}
              className="p-1.5 rounded-full hover:bg-zinc-800 text-gray-300 hover:text-white transition-colors flex items-center gap-1 text-xs px-2.5 border border-zinc-800"
